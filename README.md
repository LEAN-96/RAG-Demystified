...
![][(https://latex.codecogs.com/svg.image?d(z)=BERT_d(z),q(x)=BERT_q(x)](https://latex.codecogs.com/svg.image?\bg{white}d(z)=BERT_d(z),q(x)=BERT_q(x)))
